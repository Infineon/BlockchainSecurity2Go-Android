...
public class Voting extends Contract {
    ...
    public static final String FUNC_GETVOTERSANSWER = "getVotersAnswer";
    public static final String FUNC_GETANSWERCOUNTS = "getAnswerCounts";
    ...
    public RemoteCall<TransactionReceipt> giveVote(Utf8String voterName, Uint8 answer) {
    ...
    public RemoteCall<DynamicArray<Uint8>> getAnswerCounts() {
        final Function function = new Function(FUNC_GETANSWERCOUNTS,
                Arrays.<Type>asList(),
